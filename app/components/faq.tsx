      ...
      <Accordion type='single' collapsible className='w-full'>
        <AccordionItem value='item-1'>
          ...
          <AccordionContent>
            ...
            nicht der Fall, so sollte als Titel eine kurze Charakterisierung der
            Quelle (z.B.: „Funktionsbeschreibung der angebotenen
        ...
        <AccordionItem value='item-2'>
          ...
          <AccordionContent>
            Die Dokumente im Internet ähneln von ihrem inneren Aufbau her einer
            Schriftrolle. Aus diesem Grund können einzelne Bereiche deutlich
            länger als gedruckte Seiten sein, ohne dass sie direkt durch den
            Internet-Browser ansteuerbar sind. In solchen Fällen bereitet eine
            genaue Kennzeichnung der Fundstelle Schwierigkeiten. Wenn der Text
            in inhaltliche Abschnitte eingeteilt ist, ist die Genauigkeit der
            Angabe durch die Nennung des inhaltlichen Abschnittes, in dem sich
            das Zitat befindet, zu erhöhen. Die einzelnen inhaltlichen
            Abschnitte sind häufig vom Inhaltsverzeichnis aus über Hyperlinks
            erreichbar. Die allgemeine Form der Quellenangabe im Text lautet
            demnach: Name, Vorname der Verfasserin oder des Verfassers (Jahr),
            möglichst genaue Angabe der Fundstelle.
            <br></br>
            <blockquote>
        ...
        <AccordionItem value='item-3'>
          ...
          <AccordionContent>
            ...
            frei, seine Gedanken und Ansichten über dieses Medium zu verbreiten.
            Auf der anderen Seite erfreuen sich Internetquellen steigender
            Beliebtheit seitens der Studierenden, da sie schnell und meist frei
            zugänglich sind. So begrüßenswert diese Möglichkeit ist, sollte doch
            für die Verwendung innerhalb einer wissenschaftlichen Arbeit die
            Qualitätsprüfung noch stärker erfolgen. Kriterien der Qualität sind
            insbesondere eine sachlogisch nachvollziehbare Argumentation und
            formallogische Stringenz. Verweisen Sie nur dann auf
            Internetquellen, wenn sich diese aus Gründen der Aktualität,
            Originalität o.ä. anbieten. Eine Internet-Recherche ersetzt
            keinesfalls das Literaturstudium!
          </AccordionContent>
        </AccordionItem>
        ...
        <AccordionItem value='item-4'>
          ...
          <AccordionContent>
            ...
            vertraulichen Interviews sollten nur solche Angaben gemacht werden,
            die eine Identifikation der Interviewten oder des Interviewten nicht
            ermöglichen. Werden die Interviews im Textteil zitiert, so ist auch
            dieses Zitat mit einer Fußnote und der Fundstelle (Anhang oder
            Datenträger) zu kennzeichnen.
          </AccordionContent>
        </AccordionItem>

        <AccordionItem value='item-5'>
          <AccordionTrigger>
            Muss ich die Verwendung einer Literaturquelle, die auf einer CD-ROM
            gespeichert ist <br></br>(z.B. Fachlexika) gesondert angeben?
          </AccordionTrigger>
          <AccordionContent>
            Diese Quellen werden lediglich im Literaturverzeichnis mit dem
            Hinweis CD-ROM versehen, da sich eventuell die Seitenzahlen zu einem
            gedruckten Exemplar unterscheiden. In den Fußnoten ist die Angabe
            der Quelle wie bei einer gedruckten Literaturquelle zu handhaben.
          </AccordionContent>
        </AccordionItem>
        ...
        <AccordionItem value='item-6'>
          ...
          <AccordionContent>
            Sollte ein Sperrvermerk erforderlich sein, wird dieser dem Deckblatt
            der Arbeit vorgeschaltet. Die Seite mit dem Sperrvermerk wird nicht
            in die Nummerierung einbezogen. Ein Sperrvermerk-Muster befindet
            sich auch auf dieser Seite. Es werden nur die Kapitel gesperrt, die
            vertrauliche Daten enthalten. Diese Kapitel sind im Sperrvermerk zu
            bezeichnen. Eine elektronische Version der ungesperrten Teile des
            Praxistransferberichts/der Studienarbeit/der Bachelorarbeit (als
            Word- und pdf-Textdatei - kein Scan und kein Bild!) ist ebenfalls
            auf den Datenträgern einzureichen.
          </AccordionContent>
        </AccordionItem>
        ...
        <AccordionItem value='item-7'>
          ...
          <AccordionContent>
            ...
            schreiben. Aus diesem Grund sollten die Literaturquellen im Schnitt
            nicht älter als 5 Jahre sein. Allerdings gibt es gewisse
        ...
        <AccordionItem value='item-10'>
          ...
          <AccordionContent>
            ...
            und hilfreich sind und welche Abbildungen weggelassen werden können.
          </AccordionContent>
        </AccordionItem>
